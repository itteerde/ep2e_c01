...
\texttt{\egr{}}\index{\egr{}}'s starting gear is
\setcounter{gp}{24}
\begin{align}
    GP =    & 20 + \text{Resources IV} (4) &&\arabic{gp}\\
            %& - \text{Exploit} (2) &&\addtocounter{gp}{-2}\arabic{gp}\\ % Meshware, have from Tutorial Gear
            %& - \text{Simulspace} (1) &&\addtocounter{gp}{-1}\arabic{gp}\\ % see below, I do think it has to be available as an App, to be clarified
            %& - \text{Spoofer} (2) &&\addtocounter{gp}{-2}\arabic{gp} \\ % Meshware, have from Tutorial Gear
            %& - \text{VPN} (1) &&\addtocounter{gp}{-1}\arabic{gp} \\ % Meshware, have from Tutorial Gear
            & - \text{Private Server} (1) &&\addtocounter{gp}{-1}\arabic{gp} \\
            %& - \text{TacNet} (2) &&\addtocounter{gp}{-2}\arabic{gp} \\
            %& - \text{Tracker} (2) &&\addtocounter{gp}{-2}\arabic{gp} \\
            %& - \text{Crypto} (1) &&\addtocounter{gp}{-1}\arabic{gp} \\
